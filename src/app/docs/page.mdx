...
Motion UI is a collection of high-quality, animated components built on top of [shadcn/ui](https://ui.shadcn.com).

While shadcn/ui provides the robust, accessible primitives (buttons, inputs, dialogs), Motion UI focuses on the **interactions**—the subtle details, micro-animations, and physics-based transitions that make an interface feel alive.
...
Motion UI is not a dependency you install. It is a reference you copy from.
