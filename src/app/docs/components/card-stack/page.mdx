...
<CommandCopy 
  command={{
    npm: "npx shadcn@latest add "https://flow-kit-beta.vercel.app/r/card-stack.json"",
    pnpm: "pnpm dlx shadcn@latest add "https://flow-kit-beta.vercel.app/r/card-stack.json"",
    bun: "bunx shadcn@latest add "https://flow-kit-beta.vercel.app/r/card-stack.json"",
    yarn: "yarn dlx shadcn@latest add "https://flow-kit-beta.vercel.app/r/card-stack.json""
  }} 
>

<CollapsibleCode>
  ```tsx file=../../../../../registry/card-stack.tsx
  ```
</CollapsibleCode>
</CommandCopy>
