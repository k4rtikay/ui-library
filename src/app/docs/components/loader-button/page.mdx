...
<CommandCopy
  command={{
    npm: 'npx shadcn@latest add "https://flow-kit-beta.vercel.app/r/loader-button.json"',
    pnpm: 'pnpm dlx shadcn@latest add "https://flow-kit-beta.vercel.app/r/loader-button.json"',
    bun: 'bunx shadcn@latest add "https://flow-kit-beta.vercel.app/r/loader-button.json"',
    yarn: 'yarn dlx shadcn@latest add "https://flow-kit-beta.vercel.app/r/loader-button.json"'
  }}
>
