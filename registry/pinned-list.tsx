...
function PinnedListRow({
    ...
    return (
        <motion.li
            ...
            className={cn("relative group flex items-center bg-card border border-border/50 gap-3 rounded-lg px-3 py-2.5 hover:border-border focus-within:border-border")}>
            ...
            <button
                ...
                <motion.div
                    ...
                    transition={{
                        ...
                        rotate: { delay: item.pinned ? 0.2 : 0, duration: 0.15, ease: "easeInOut" },
                    }}
                >
                    <PinIcon className="w-4 h-4" pinned={item.pinned} />
                </motion.div>
            </button>
        </motion.li>
    );
